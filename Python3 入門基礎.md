...
|變數名稱|變數名稱|可變(mutable)|範例|
|-|-|-|-|
|布林|bool|Value|v = True|
|整數|int|Value|v = 20|
|浮點數|float|Value|v = 20.5|
|複數|complex|Value|v = 1j|
|字串|str|Value|v = “Hello World”|
|bytes|bytes|Value|v = b"Hello"|
|bytearray|bytearray|Reference|v = bytearray(5)|
|tuple|tuple|Value|v = (“apple”, “banana”, “cherry”)|
|list|list|Reference|v = [“apple”, “banana”, “cherry”]|
|set|set|Reference|v = set [“apple”, “banana”, “cherry”]|
|dict|dict|Reference|v = {“name” : “John”, “age” : 36}|
|memoryview|memoryview|Reference|v = memoryview(bytes(5))|
|frozenset|frozenset|Value|v = frozenset({“apple”, “banana”, “cherry”})|

`*` mutable和immutable相當於變數中的實質型別與參考型別
...
fl = 1.0009
print(int(fl))  # 1
print(type(int(fl)))  # <class 'int'>

cp = 1.0e1
print(int(cp))  # 10
print(type(int(cp)))  # <class 'int'>

null = ""
# print(int(null))  # ValueError: invalid literal for int() with base 10: ''
