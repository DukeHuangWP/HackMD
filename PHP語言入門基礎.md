...
### 13. 型別運算子(Type Operator)

判斷一個變數是否為某一種類別，並將結果以布林回傳。變數如果繼承自某個類別或實作於某個介面(Interface)，判斷結果會回傳TRUE；另外也可使用另一個物件或字串來判斷：
...
<tr>
<th>if {..}<br />elseif {...}<br />else {...}<br />endif;</a></th>
<td>if($a &gt; $b) {echo("a is bigger than b");}<br />elseif ($a == $b) {...}<br />else {...}<br />endif;</td>
</tr>
<tr>
<th>for</a></th>
...
<tr>
<th>do ... while</th>
<td>do<br />{ print $i; $i++;<br />} while($i&lt;=10)</td>
</tr>
<tr>
<th>while {...}</a></th>
<td>while ($i &lt;= 10)<br />{ print $i; $i++;}</td>
</tr>
<tr>
<th>break</a></th>
<td>跳離loop</td>
...
<tr>
<th>switch expN {<br />case expN:<br />statemant;<br />break;<br />case expN: ...<br />default:<br />statement;<br />}</th>
<td>switch ($i) {<br />case 0:<br />　print "i equals 0";<br />　break;<br />case 1:<br />　print "i equals 1";<br />　break;<br />default:<br />　print "...";<br />}</td>
</tr>
<tr>
<th> </th>
<td> </td>
